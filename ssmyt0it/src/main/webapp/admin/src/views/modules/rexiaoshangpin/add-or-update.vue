        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.fenlei"
                placeholder="分类" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="花语" prop="huayu">
          <el-input v-model="ruleForm.huayu" 
              placeholder="花语" clearable  :readonly="ro.huayu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="花语" prop="huayu">
              <el-input v-model="ruleForm.huayu" 

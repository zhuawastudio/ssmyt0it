          ...
          <el-form-item class="input" v-if="ruleForm.zongjiage" label="总价格" prop="zongjiage">
              <el-input v-model="ruleForm.zongjiage" 
                placeholder="总价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="销售备注" prop="xiaoshoubeizhu">
          <el-input v-model="ruleForm.xiaoshoubeizhu" 
              placeholder="销售备注" clearable  :readonly="ro.xiaoshoubeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="销售备注" prop="xiaoshoubeizhu">
              <el-input v-model="ruleForm.xiaoshoubeizhu" 
                placeholder="销售备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjiage = true;
            continue;
	            	            ...
	            	            if(o=='xiaoshoubeizhu'){
            this.ruleForm.xiaoshoubeizhu = obj[o];
	    this.ro.xiaoshoubeizhu = true;
            continue;
          }
	                    }
                                                                                                                              }
